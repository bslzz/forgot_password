...
exports.verifyNewPassword = exports.sendForgotPasswordEmail = void 0;
...
const verifyNewPassword = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return next(http_errors_1.default(401, 'Invalid token'));
    }
});
